...
// import modelYOldImage from "../assets/model-y-old.png"; // Available for older Model Y variants
...
export const teslaVehicles: TeslaVehicle[] = [
  // Model S
  {
    model: "Model S",
    trim: "2016 (60 / 60D)",
  ...
  // Model 3 - Use old image for vehicles that don't include 2025
  {
    ...
    imageUrl: model3OldImage, // Doesn't include 2025, use old image
  },
  {
    model: "Model 3",
    ...
    imageUrl: model3NewImage, // Includes 2025, use new image
  },
  {
    model: "Model 3",
  ...
  // Model Y - Use old image for vehicles that don't include 2025
  {
    ...
    battery_kWh: 79,
    charge_time_0_to_80: "11h 48m",
    imageUrl: modelYNewImage, // Includes 2025, use new image
  },
  {
    model: "Model Y",
...
export function getUniqueModels(): TeslaModel[] {
  const models = [...new Set(teslaVehicles.map((v) => v.model))];
